...
function showPhotos(photos) {
  ...
  photos.forEach(photo => {
    ...
    photoCard.innerHTML = `
        <img class='photo-image' src='https://image.tmdb.org/t/p/original${
          photo.file_path
        }'>
        `;
  ...
  credits.forEach(credit => {
    ...
    if (credit.media_type === "movie") {
      ...
      cardCredit.innerHTML = `
        <div class='credit-flex' onClick='movieSelected("${credit.id}","${
        credit.media_type
      }")'>
        <div>
        <img class='credit-img' src='https://image.tmdb.org/t/p/original${
          credit.poster_path
        }' alt='Filmography'> 
        </div> 
        <div>
